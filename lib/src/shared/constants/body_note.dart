...
class BodyNote extends StatefulWidget {
  const BodyNote({
    Key? key,
  }) : super(key: key);

  @override
  _BodyNoteState createState() => _BodyNoteState();
}

class _BodyNoteState extends State<BodyNote> {
  @override
          ...
          child: Container(
            ...
            child: Stack(
              children: [
                ...
                Container(
                  child: Padding(
                    padding: const EdgeInsets.only(top: 8.0, left: 7.75),
                    child: Text(
                      "Não esquecer",
                ...
                Padding(
                  padding: const EdgeInsets.only(right: 9.33, top: 49.0),
                  child: Row(
                ...
                Padding(
                  padding:
                      const EdgeInsets.only(top: 71.0, left: 8.0, right: 8.0),
                  child: Text(
          ...
          child: Container(
            ...
            child: Stack(
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.only(right: 9.33, top: 61.66),
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.end,
                    children: [
                      Icon(
                ...
                Padding(
                  padding: const EdgeInsets.only(top: 85.0, left: 8.0),
                  child: Text(
          ...
          child: Container(
            ...
            child: Stack(
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.only(right: 9.33, top: 62.0),
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.end,
                    children: [
                      Icon(
                ...
                Padding(
                  padding: const EdgeInsets.only(top: 84.0, left: 8.0),
                  child: Text(
                    " • Ipsum dolor sit amet, consectur. \n\n • Adipiscing elit, sed do eiusmod tempor incidi.\n\n • Ut labore dolore .",
                    textAlign: TextAlign.start,
                    style: TextStyle(
